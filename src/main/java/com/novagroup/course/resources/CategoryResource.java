...
import com.novagroup.course.services.CategoryService;
...
public class CategoryResource {
	...
	public ResponseEntity<Category> findById(@PathVariable Long id){ /* Pro Spring aceitar o id que vai vir por parâmetro pela url*/
